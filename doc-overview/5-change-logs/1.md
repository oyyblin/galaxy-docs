...
When users verify their Twitter accounts, we will require the user to enable write permission. We will use this permission to help them follow other Twitter users, like, or retweet a credential tweet. Click the “manually verify” button and this service will help users follow, like, and retweet. This update supports Follow, Like, and Retweet type credentials.

**Project Galaxy Web Updates**

\-CI changes have been reverted and gql types have been updated. card UI bugs have been fixed as well. (what does this mean? Could I get more of a description?)

\-Users can now share campaign/campaign details along with space detail pages now. (what does this mean? Could I get more of a description?)

![](assets/截屏2022-08-15-14.02.45-1-.png)

![](assets/截屏2022-08-15-14.03.05-1-.png)

\-Added clearer documentation guidance when users create subgraph credentials.
...
**NFT Holder Credential - snapshot version**

Currently, this feature can only be created from the backend.

**Discord Message Credential**

Members who messaged ??? times can be awarded an OAT. Currently, this feature can only be created from the backend.

**Claimable Campaigns Email Notification**

This feature will ensure that users won’t ever have to worry about keeping track of the campaigns we power. Instead, a weekly email will be sent out with a list of active campaigns and instructions on how to get involved!
